...
| 8 Push/deploy                | PUSHED; production BLOCKED                            | No remote migration, Worker deploy, merge, or Pages release. PR CI is read-only and cannot deploy; production requires exact backend source readiness.                                                                                                                                               |
